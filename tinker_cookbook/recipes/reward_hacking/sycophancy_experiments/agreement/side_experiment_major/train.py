"""SFT entry point for the math-vs-CS side experiment.
...
@chz.chz
class CLIConfig:
    """SFT config for the side experiment. Defaults target Llama-3.2-1B-Instruct."""

    dataset_path: str  # required: pro_math.jsonl or pro_cs.jsonl
    ...
    log_path: str = "/tmp/side_experiment_sft"
